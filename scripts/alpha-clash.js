...
function handleKeyboardButtonKeyPress(event){
    ...
    if(playerPressed === expectedAlphabet){
        ...
        console.log('Durr vai,right key press koren');
...
document.addEventListener('keyup', handleKeyboardButtonKeyPress)
...
function gameOver(){
    ...
    // 2. show the final/last score on the page
